...
<form id="form" name="form" action="${basePath }nsfw/user_add" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
                    ...
                    <tr>
                        ...
                        <%--<td><label>男</label></laber><input type="radio" name="user.gender" value="1">&nbsp;<label>女</label></laber><input type="radio" name="user.gender" value="0"></td>--%>
                    </tr>
                    <tr>
