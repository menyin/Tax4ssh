...
<%--<c:forEach items="${requestScope.userList}" var="user" varStatus="userStatus">--%>
    <%--<p>${user.name}+++${userStatus.count}</p>--%>
<%--</c:forEach>--%>
            ...
            <div class="content_info">
                ...
                <div class="t_list" style="margin:0px; border:0px none;">
                    <table width="100%" border="0">
                        ...
                        <c:forEach items="${requestScope.userList}" var="user" varStatus="userStatus">
                            <tr <c:if test="${userStatus.index%2==0}">bgcolor="f8f8f8"</c:if> >
...
<script>
    /*用于测试ajax接口*/
    $.post('/nsfw/user_ajax',{dept:'管理员'},function (data) {
        debugger;
        console.log(data);
    });
</script>
